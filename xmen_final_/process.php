...
if (isset($_POST['submit'])) {
    ...
    $altura = $_POST['altura'] ?? '';
    $bio = $_POST['bio'] ?? '';
    $equipo_id = $_POST['equipo_id'] ? (int)$_POST['equipo_id'] : NULL;
    ...
    try {
        $sql = "INSERT INTO mutantes (nombre_clave, nombre_real, poderes, altura, bio, imagen, equipo_id) 
                VALUES (:nombre, :nombrereal, :poderes, :altura, :bio, :imagen, :equipo_id)";
